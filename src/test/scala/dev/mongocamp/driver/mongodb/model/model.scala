...
case class Product(_id: String, name: String, brand: String, `type`: String, price: Double, rating: Double, warranty_years: Double, available: Boolean)
...
case class Place(_id: ObjectId, name: String, location: Location, category: String)

case class Location(locationType: String, coordinates: List[Double])
